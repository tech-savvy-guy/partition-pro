...
--
-- TOC entry 327 (class 1255 OID 127218)
-- Name: get_basemath_matrix_rows_by_skuname_v1(uuid, uuid, text[]); Type: FUNCTION; Schema: core; Owner: -
--

CREATE FUNCTION core.get_basemath_matrix_rows_by_skuname_v1(_case_id uuid, _pp_basemath_id uuid, _selected_skunames text[] DEFAULT NULL::text[]) RETURNS TABLE(sku_l text, sku_r text, roi real)
