...
import { ArrowLeft, ChevronDown, ChevronUp } from "@carbon/icons-react";
import { Table, Col as Column } from "@/components/table/Table";
import BaseTestingResultWithAttribute from "./BaseTesting/BaseTestingResultWithAttribute";
import type {
  BaseTestingItem,
  BaseTestingSummary,
} from "./BaseTesting/BaseTestingResult";
import DetailedResultsWithPartitionTree from "./LevelTesting/DetailedResultsWithPartitionTree/DetailedResultsWithPartitionTree";
import type { LevelTestingPair, LevelTestingPayload } from "./LevelTesting/Index";
