  ...
  return (
    <div className="p-4 h-full flex flex-col min-h-0">
      <div ref={tableContainerRef} className="flex-1 min-h-0">
        ...
        onRowClick={(e) => {
          onSelectAttribute(e.data.id);
        }}
        rowClassName={(row: BaseTestingRow) => {
          return row.id === selectedAttributeId ? "selected-row" : "";
        }}
      >

        <Column header="No." body={(_, options) => options.rowIndex + 1} // Override S. No. to be 1-based index
        />
        ...
        />
        <Column field="wtdAverageRoi" header="Wtd Average ROI" />
