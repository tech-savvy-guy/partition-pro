...
--
-- TOC entry 321 (class 1255 OID 66780)
-- Name: get_basemath_full_test(uuid, uuid, uuid, uuid[], text); Type: FUNCTION; Schema: core; Owner: -
--

CREATE FUNCTION core.get_basemath_full_test(_case_id uuid, _pp_metadata_id uuid, _pp_basemath_id uuid, _selected_ids uuid[], _view text) RETURNS json
    LANGUAGE plpgsql
    AS $$
DECLARE
  result json;
